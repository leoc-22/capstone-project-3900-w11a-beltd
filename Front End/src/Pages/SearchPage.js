    ...
    return (
        ...
        <AuthenicatedTopBar>  
            ...
            <ButtonGroup color="secondary" theme={theme} variant="text">
                <Button><span class = {classes.Categorybtn}>All Categories</span></Button>
                <Button><span class = {classes.Categorybtn}>Category1</span></Button>
                <Button><span class = {classes.Categorybtn}>Category2</span></Button>
                <Button><span class = {classes.Categorybtn}>Category3</span></Button>
                <Button><span class = {classes.Categorybtn}>Category4</span></Button>
                <Button><span class = {classes.Categorybtn}>Category5</span></Button>
                <Button><span class = {classes.Categorybtn}>Category6</span></Button>
                <Button><span class = {classes.Categorybtn}>Category7</span></Button>
                <Button><span class = {classes.Categorybtn}>Category8</span></Button>
                <Button><span class = {classes.Categorybtn}>Category9</span></Button>
            </ButtonGroup>
            <br></br>
