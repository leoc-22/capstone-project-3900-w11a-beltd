...
week5
I added bookProfile pages and connected it with the amazon rainforest API on the backend, this was done by parametising the URL. I also connected the user profile page where the user could now upload an image. 
